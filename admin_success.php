  ...
  <div class="row">
    <div class="span12">
      <div class="hero-unit center">
          <h1>Result Sent Successfully!!! <small><font face="Tahoma" color="green">Success</font></small></h1>
          <br>
          <p><h4>The result was successfully sent to all registered students. Use your browsers <b>Back</b> button to navigate to the page you have prevously come from</p>
